                                    ...
                                    <table class="table table-striped table-bordered table-list">
                                        ...
                                        @foreach($categories as $category)
                                            <tr>
                                                <td>{{ $category->name }}</td>
                                                {{--                                                <td></td>--}}
                                                {{--                                                <td>{{ $data->role ? 'Super Admin':'Admin' }}</td>--}}
                                                <td align="center">
                                                    <a class="btn btn-default"
                                                       href="{{route('category.edit',['category' => $category->id])}}"><em
                                                            class="fa fa-eye"></em></a>
                                                    {{--                                                    <a onclick="event.preventDefault(); document.getElementById('delete-user-{{ $data->id }}').submit()"--}}
                                                    {{--                                                       class="btn btn-danger"--}}
                                                    {{--                                                       href="{{route('delete',['user' => $data->id])}}"><em--}}
