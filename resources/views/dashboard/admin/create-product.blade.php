            ...
            <div class="card-body">
                ...
                <form action="{{ route('products.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-12 p-0-1">
                            <div class="form-floating">
                                <input value="{{ old('name') }}" name="name" type="text"
                                    class="form-control @error('name') is-invalid @enderror" id="floatingInputGrid"
                        ...
                        <div class="col-12 p-0-1">
                            <div class="form-floating">
                                <select name="category_id" required class="form-control @error('type') is-invalid @enderror"
                        ...
                        <div class="col-12 p-0-1">
                            <div class="form-floating">
                                <select name="type" required class="form-control @error('type') is-invalid @enderror"
                                    id="floatingInputGrid" placeholder="السعر">
                                    <option {{ old('type') === 'product' ? 'selected' : '' }} value="product">
                                        منتج عادي
                                    </option>
                                    <option {{ (old('type') ?? '') === 'reservation' ? 'selected' : '' }}
                                        value="reservation">
                                        حجوزات
                                    </option>
                                </select>
                        ...
                        <div class="col-12 p-0-1 {{ old('type') === 'reservation' ? '' : 'd-none' }}" id="require_end_date">
                            <div class="form-check">
                                <input name="require_end_date" type="checkbox"
                                    {{ old('require_end_date') ? 'checked' : '' }}
                                    class="form-check-input @error('require_end_date') is-invalid @enderror" id="checkbox"
                                    placeholder="السعر">
                                <label for="checkbox" class="form-check-label">الحجز يتطلب تاريخ انتهاء ؟<span
                        ...
                        <div class="col-12 p-0-1">
                            <div class="form-floating">
                                <select name="unit" required class="form-control @error('unit') is-invalid @enderror"
                                    id="floatingInputGrid" placeholder="السعر">
                                    <option {{ old('unit') === 'quantity' ? 'selected' : '' }} value="quantity">قطعة
                                    </option>
                                    <option {{ old('unit') === 'reservation' ? 'selected' : '' }} value="nights"
                                        {{ old('type') === 'reservation' ? 'disabled' : '' }}>
                                        مدة زمنية
                                    </option>
                                </select>
                        ...
                        <div class="col-12 p-0-1">
                            <div class="form-floating">
                                <input value="{{ old('price') }}" name="price" required
                                    class="form-control @error('price') is-invalid @enderror" id="floatingInputGrid"
