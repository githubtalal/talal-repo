<template>
    <el-button  class="info-btn" @click="open">
        {{btnTitle}}
    </el-button>
</template>
<!--        <i class="el-icon el-message-box__status el-message-box-icon&#45;&#45;info">-->
...
export default {
    ...
    methods:{
        open() {
            ...
            // if (this.$props.modalType == "info" || this.$props.modalType =="success") {
            //
            // } else {
                //
                // ElMessageBox.confirm(
